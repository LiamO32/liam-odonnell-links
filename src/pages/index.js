...
import { FaYoutube, FaInstagram, FaTwitter, FaMusic, FaLinkedin } from 'react-icons/fa'
      ...
      <Layout>
        <section className='flex-center-column'>
          ...
          <section className="links flex-center-column">
            <a className="linkedin" href="https://www.linkedin.com/in/imliamodonnell/"><FaLinkedin/>LinkedIn</a>
